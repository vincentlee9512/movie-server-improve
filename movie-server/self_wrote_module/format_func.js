module.exports = {
    title_table: function title_table_html(sql_result) {
        let type_list = [
    ...
    people_table: function people_table_html(sql_result) {
        let pro_list = ['actor',
            'actress',
    ...
    title_individual: function format_individual_movie(sql_result) {
        let returnObj = {};
        ...
        for (let i = 0; i < sql_result.length; i++) {
            html_code += "<li><a href=\"" + main_page + "/individual?nconst=" + sql_result[i].nconst +
    ...
    people_individual: function format_individual_person(sql_result) {
    let return_obj = {};
    ...
    people_list: function populate_people_list(sql_result_arr) {
        var html_code = "<ul style='list-style-type: none'>";

        for (var i = 0; i < sql_result_arr.length; i++) {
            html_code += "<li><a href=\"" + main_page + "/individual?nconst=" +
    ...
    titles: function populate_known_titles(sql_result_arr) {
        var html_code = "<ul style='list-style-type: none'>";

        for (var i = 0; i < sql_result_arr.length; i++) {
            html_code += "<li><a href=\"" + main_page + "/individual?tconst=" +
